defmodule WandererKills.Ingest.Killmails.BatchProcessorTest do
  ...
  describe "extract_all_characters/1" do
    test "extracts unique character IDs from multiple killmails" do
      ...
      killmail_map_2 = TestFactory.build_killmail(123_456_790, %{
        ...
        "attackers" => [
          %{
            "character_id" => 1002, # Same as first killmail
            "corporation_id" => 2002,
            "ship_type_id" => 590,
            "damage_done" => 1500,
            "final_blow" => true
          ...
          %{
            "character_id" => 1004, # New character
            "corporation_id" => 2004,
            "ship_type_id" => 591,
            "damage_done" => 500,
            "final_blow" => false
  ...
  describe "find_interested_subscriptions/1" do
    ...
    test "returns empty map for killmails with no character subscriptions" do
      ...
      killmail_map = TestFactory.build_killmail(123_456_789, %{
        "victim" => %{
          "character_id" => 999_999_999, # Unlikely to have subscriptions
          "corporation_id" => 2001,
          "ship_type_id" => 587,
          "damage_taken" => 1000
        },
        "attackers" => [
          %{
            "character_id" => 999_999_998, # Unlikely to have subscriptions
            "corporation_id" => 2002,
            "ship_type_id" => 588,
            "damage_done" => 1000,
            "final_blow" => true
  ...
  describe "match_killmails_to_subscriptions/2" do
    test "matches killmails to subscription character map" do
      ...
      subscription_character_map = %{
        ...
        "subscription_3" => MapSet.new([9999]) # No match
      }

      result = BatchProcessor.match_killmails_to_subscriptions(killmails, subscription_character_map)
