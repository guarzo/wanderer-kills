...
- [x] **Remove backwards compatibility functions**
...
- [x] **Add explicit Clock alias in health_checks.ex inner modules**
...
- [x] **Fix duplicate port configuration**
...
- [x] **Replace Code.require_file with import_config**
  - Location: `config/config.exs:87-90`
  - ✅ Moved LoggerMetadata module to `lib/wanderer_kills/logger_metadata.ex`
  - ✅ Updated config to use `:all` metadata setting

- [x] **Consolidate dev.exs configuration blocks**
  - Location: `config/dev.exs:10-15 and line 28`
  - Merge two separate config blocks for WandererKillsWeb.Endpoint into one

## Documentation Updates

- [x] **Update HTTP client behaviour documentation**
...
- [x] **Update client_behaviour.ex documentation**
  - Location: `lib/wanderer_kills/client_behaviour.ex:76,95`
  - Replace "kill updates" with "killmail" for consistency

## API & Routing

- [x] **Fix smoke test to use versioned API route**
  - Location: `test/integration/api_smoke_test.exs:3-8`
  - ✅ Decided to keep infrastructure routes (ping, health) unversioned

- [x] **Remove unnecessary secure browser headers plug**
...
- [x] **Replace custom RequestId plug with Phoenix built-in**
...
- [x] **Fix ApiLogger response size type consistency**
...
- [x] **Add IPv6 support to ApiLogger**
...
- [x] **Fix nil string concatenation in user_socket.ex**
...
- [x] **Fix Monitoring increment functions**
...
- [x] **Fix WebSocketStats usage in RedisQ**
  - Location: `lib/wanderer_kills/redisq.ex:257-262`
  - Replace KillmailChannel.get_stats() with WebSocketStats module call

## Data Processing & Storage

- [x] **Fix killmail controller error handling**
  - Location: `lib/wanderer_kills_web/controllers/kills_controller.ex`
  - ✅ fetch_systems_killmails always returns {:ok, _}
  - ✅ get_killmail returns nil on not found

- [x] **Fix validator to use system_id**
...
- [x] **Optimize killmail_store duplicate checking**
...
- [x] **Review and remove Flow dependency**
  - Location: `mix.exs:66-68`
  - ✅ Flow is actively used throughout the codebase for concurrent processing
  - ✅ Keeping Flow as it provides valuable concurrency control

- [x] **Remove phoenix_html dependency**
  - Location: `mix.exs:48-52`
  - Remove unnecessary HTML rendering dependency from API-only project

- [x] **Fix ETS Manager configuration**
...
- [x] **Fix logger compile-time level check**
...
- [x] **Fix or remove ineffective cache tests**
...
- [x] **Add more test coverage for helpers**
...
- [x] **Update documentation security notes**
...
- [x] **Fix api-reference.md**
  - Line 321: Add trailing newline

- [x] **Fix integration-guide.md**
...
- [x] **Add missing gettext import**
  - Location: `lib/wanderer_kills_web.ex:11-16`
  - ✅ Skipped - API-only app doesn't need gettext for internationalization

- [x] **Fix ShipTypes.Updater logging**
  - Location: `lib/wanderer_kills/ship_types/updater.ex:140-147`
  - Pass csv_result as metadata instead of interpolating

- [x] **Fix Statistics nested case**
