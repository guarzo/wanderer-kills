defmodule WandererKills.Core.Support.Retry do
  @moduledoc """
  ...
  def retriable_http_error?(%WandererKills.Core.Support.Error.RateLimitError{}), do: true
  def retriable_http_error?(%WandererKills.Core.Support.Error.TimeoutError{}), do: true
  def retriable_http_error?(%WandererKills.Core.Support.Error.ConnectionError{}), do: true
