defmodule WandererKills.Core.Support.PubSubTopics do
  @moduledoc """
  ...
  ## Examples
      iex> WandererKills.Core.Support.PubSubTopics.system_topic(30000142)
      "zkb:system:30000142"
  """
  ...
  ## Examples
      iex> WandererKills.Core.Support.PubSubTopics.system_detailed_topic(30000142)
  ...
  ## Examples
      iex> WandererKills.Core.Support.PubSubTopics.system_topics(30000142)
  ...
  ## Examples
      iex> WandererKills.Core.Support.PubSubTopics.all_systems_topic()
      "zkb:all_systems"
  """
  ...
  ## Examples
      iex> WandererKills.Core.Support.PubSubTopics.valid_system_topic?("zkb:system:30000142")
      true

      iex> WandererKills.Core.Support.PubSubTopics.valid_system_topic?("invalid:topic")
      false
  """
  ...
  ## Examples
      iex> WandererKills.Core.Support.PubSubTopics.extract_system_id("zkb:system:30000142")
      {:ok, 30000142}

      iex> WandererKills.Core.Support.PubSubTopics.extract_system_id("zkb:system:30000142:detailed")
      {:ok, 30000142}

      iex> WandererKills.Core.Support.PubSubTopics.extract_system_id("invalid:topic")
      {:error, :invalid_topic}
  """
