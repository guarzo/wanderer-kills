defmodule WandererKills.Core.Observability.HealthAggregator do
  @moduledoc """
  ...
  defp get_health_module(:application), do: WandererKills.Core.Observability.ApplicationHealth
  defp get_health_module(:cache), do: WandererKills.Core.Observability.CacheHealth
