defmodule WandererKills.Ingest.Http.ClientBehaviour do
  @moduledoc """
  ...
  - Return standardized error responses using `WandererKills.Core.Support.Error`
  ...
  ## Example Implementation
      ...
      defmodule MyHttpClient do
        @behaviour WandererKills.Ingest.Http.ClientBehaviour
