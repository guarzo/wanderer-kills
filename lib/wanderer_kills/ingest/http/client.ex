defmodule WandererKills.Ingest.Http.Client do
  @moduledoc """
  ...
  ## Usage
      ...
      {:ok, response} = WandererKills.Ingest.Http.Client.get_with_rate_limit("https://api.example.com/data")
      ...
      {:ok, response} = WandererKills.Ingest.Http.Client.get_with_rate_limit("https://api.example.com/data", opts)

  ## Error Handling

  The module defines several custom error types (in `WandererKills.Core.Support.Error`):
  ...
  @max_delay Application.compile_env(:wanderer_kills, [:http, :retry, :max_delay], 30_000)
  ...
  defp http_client do
    Application.get_env(:wanderer_kills, :http, [])[:client] || __MODULE__
  end

  # ============================================================================
  # HTTP Client Configuration (from ClientProvider)
  # ============================================================================
