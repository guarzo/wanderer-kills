defmodule WandererKills.Killmails.FieldNormalizer do
  ...
  defp normalize_kill_id(%{"killID" => id} = killmail) when not is_map_key(killmail, "killmail_id") do
    killmail
  ...
  defp normalize_kill_time(%{"killmail_time" => time} = killmail) when not is_map_key(killmail, "kill_time") do
    killmail
