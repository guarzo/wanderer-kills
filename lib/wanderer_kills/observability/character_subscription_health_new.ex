defmodule WandererKills.Observability.CharacterSubscriptionHealthNew do
  @moduledoc """
  ...
  ## Usage
      ...
      # Check health status
      health = CharacterSubscriptionHealthNew.check_health()
      
      # Get detailed metrics
      metrics = CharacterSubscriptionHealthNew.get_metrics()
  """
