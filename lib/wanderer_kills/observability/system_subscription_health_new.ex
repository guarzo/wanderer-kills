defmodule WandererKills.Observability.SystemSubscriptionHealthNew do
  @moduledoc """
  ...
  ## Usage
      ...
      # Check health status
      health = SystemSubscriptionHealthNew.check_health()
      
      # Get detailed metrics
      metrics = SystemSubscriptionHealthNew.get_metrics()
  """
